@extends('layouts.index', ['title' => 'Thùng rác - Chức vụ'])
    ...
    <div class="card shadow mb-4">
        @if (count($chucVus) > 0)
            <div class="trash-action card-header py-3 d-flex flex-row align-items-center">
                <a href="#" class="btn btn-primary btn-icon-split btn-restore-all mr-3"
                   ...
                   data-redirect="{{ route('chucvu.index') }}">
        ...
        <div class="card-body">
            <div class="table-responsive">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="#" class="btn btn-primary btn-restore"
                                       data-url="{{ route('chucvu.restore') }}" data-id="{{ $item->id }}">Phục
                                        hồi</a>
                                    <a href="#" class="btn btn-danger btn-force-delete"
                                       data-url="{{ route('chucvu.force-destroy') }}"
                ...
                {{ $chucVus->render('pagination::bootstrap-4') }}
            </div>
        </div>
    </div>
@endsection
