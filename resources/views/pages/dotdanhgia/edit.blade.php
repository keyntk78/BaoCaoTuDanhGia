@extends('layouts.index', ['title' => 'Chỉnh sửa đợt đánh giá'])
            ...
            <form action="{{ route('dotdanhgia.update', ['id' => $dotDanhGia->id]) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control {{ $errors->has('giaiDoan') ? 'is-invalid' : '' }}" id="giaiDoan"
                        name="giaiDoan" value="{{ old('giaiDoan', $dotDanhGia->giaiDoan) }}">
                    ...
                    <select class="form-control tags-select-only" multiple="multiple" name="nganh[]">
                        @php
                            ...
                            foreach ($dotDanhGia->nganh as $item) {
                                $nganhIdCurrents[] = $item->id;
                            }
                            $nganhIds = old('nganh', $nganhIdCurrents) != '' ? old('nganh', $nganhIdCurrents) : [];
                        @endphp
