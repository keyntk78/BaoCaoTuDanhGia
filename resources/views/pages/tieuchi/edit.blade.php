                ...
                <div class="form-group">
                    ...
                    <select class="form-select form-control {{ $errors->has('boTieuChuan_id') ? 'is-invalid' : '' }}"
                        ...
                        @foreach ($boTieuChuans as $item)
                            <option value="{{ $item->id }}" {{ old('',$tieuChi->boTieuChuan_id) == $item->id ? 'selected' : '' }}>{{$item->ten}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group">
                    ...
                    <select class="form-select form-control {{ $errors->has('tieuChuan_id') ? 'is-invalid' : '' }}"
                        ...
                        <option value="{{$tieuChi->tieuChuan_id}}">
                           Tiêu chuẩn số {{$tieuChi->sttTieuChuan}} : {{$tieuChi->tenTieuChuan}}
                        </option>
...
{{--                        @endforeach--}}
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" rows="10" id="ghiChu" name="ghiChu">{{ old('ghiChu', $tieuChi->ghiChu) }}</textarea>
                </div>
