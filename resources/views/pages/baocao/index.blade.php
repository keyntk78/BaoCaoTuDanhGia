@extends('layouts.index', ['title' => 'Viết báo cáo'])
        ...
        <div class="card-body">
            <form action="{{ route('baocao.index') }}" method="GET">
                ...
                <div class="form-group d-flex justify-content-center">
                    ...
                    <a href="{{ route('baocao.index') }}" class="btn btn-secondary mx-2">Làm mới</a>
                </div>
            </form>
        </div>
    </div>
        ...
        <div class="card-body">
            <div class="table-responsive">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <a href="{{ route('baocao.index') }}" class="btn btn-primary mx-2">Làm mới</a>
                    </div>
                </div>
            </div>
        </div>
