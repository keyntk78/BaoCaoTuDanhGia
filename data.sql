...
-- Thời gian đã tạo: Th2 19, 2023 lúc 06:04 PM
-- Phiên bản máy phục vụ: 8.0.32-0ubuntu0.22.04.2
-- Phiên bản PHP: 8.1.2-1ubuntu2.10
...
--
-- Cơ sở dữ liệu: `tudanhgia`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `bao_caos`
--

CREATE TABLE `bao_caos` (
  `id` bigint UNSIGNED NOT NULL,
  `moTa` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `diemManh` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `diemTonTai` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `keHoachHanhDong` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `diemTDG` int DEFAULT NULL,
  `moDau` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `ketLuan` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `tongSoTC` int DEFAULT NULL,
  `soTCDat` int DEFAULT NULL,
  `trangThai` tinyint(1) DEFAULT NULL,
  `congKhai` tinyint(1) DEFAULT NULL,
  `nganh_id` int NOT NULL,
  `tieuChi_id` int NOT NULL,
  `tieuChuan_id` int NOT NULL,
  `dotDanhGia_id` int NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `bao_caos`
--
...
(9, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 0, 0, 0, 1, 55, 5, 1, 11, NULL, '2022-06-05 05:34:36', '2022-06-17 08:15:00'),
(10, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 1, 11, 5, 1, 11, NULL, '2022-06-05 05:34:42', '2022-06-17 08:15:00'),
(11, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 0, 0, 0, 1, 56, 6, 1, 11, NULL, '2022-06-05 05:34:47', '2022-06-17 08:15:00'),
(12, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 1, 14, 6, 1, 11, NULL, '2022-06-05 05:34:52', '2022-06-17 08:15:00'),
(13, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 1, 0, 0, 1, 52, 2, 1, 5, NULL, '2022-06-05 05:35:21', '2022-06-17 08:15:00'),
(14, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 1, 5, 3, 1, 5, NULL, '2022-06-05 05:35:42', '2022-06-17 08:15:00'),
(15, '<p>M&ocirc; tả ti&ecirc;u ch&iacute; 2.2</p>', NULL, NULL, NULL, 4, NULL, NULL, NULL, NULL, 0, 0, 1, 6, 3, 1, 5, NULL, '2022-06-05 05:35:50', '2022-06-17 08:15:00'),
(16, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 1, 9, 4, 1, 5, NULL, '2022-06-05 05:35:58', '2022-06-17 08:15:00'),
(17, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 5, 0, 0, 0, 1, 58, 8, 1, 15, NULL, '2022-06-06 05:36:10', '2022-06-17 08:15:00'),
(18, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 1, 26, 8, 1, 15, NULL, '2022-06-06 05:36:16', '2022-06-17 08:15:00'),
...
(86, '<p>M&ocirc; tả ti&ecirc;u ch&iacute; 1.1</p>', NULL, NULL, NULL, 4, NULL, NULL, NULL, NULL, 0, 0, 1, 2, 2, 1, 5, NULL, '2022-06-11 10:01:42', '2022-06-17 08:15:00');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `bao_cao_minh_chungs`
--

CREATE TABLE `bao_cao_minh_chungs` (
  `id` bigint UNSIGNED NOT NULL,
  `baoCao_id` int NOT NULL,
  `minhChung_id` int NOT NULL,
  `tieuChuan_id` int NOT NULL,
  `tieuChi_id` int NOT NULL,
  `nganh_id` int NOT NULL,
  `dotDanhGia_id` int NOT NULL,
  `maHMC` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `bao_cao_minh_chungs`
--
...
(213, 26, 6, 2, 2, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(214, 26, 7, 2, 2, 3, 3, 'H1.01.01.02', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(215, 26, 8, 2, 2, 3, 3, 'H1.01.01.03', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(216, 27, 9, 2, 3, 3, 3, 'H1.01.02.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(217, 27, 6, 2, 3, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(218, 27, 6, 2, 3, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(219, 28, 6, 2, 4, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(220, 28, 10, 2, 4, 3, 3, 'H1.01.03.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(221, 28, 11, 2, 4, 3, 3, 'H1.01.03.02', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(222, 28, 12, 2, 4, 3, 3, 'H1.01.03.03', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(223, 30, 6, 3, 5, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(224, 30, 13, 3, 5, 3, 3, 'H2.02.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(225, 30, 14, 3, 5, 3, 3, 'H2.02.01.02', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(226, 31, 13, 3, 6, 3, 3, 'H2.02.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(227, 31, 14, 3, 6, 3, 3, 'H2.02.01.02', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(228, 32, 6, 3, 7, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(229, 32, 15, 3, 7, 3, 3, 'H2.02.03.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(230, 34, 6, 4, 8, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(231, 34, 6, 4, 8, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(232, 34, 6, 4, 8, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(233, 35, 6, 4, 9, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(234, 35, 6, 4, 9, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(235, 36, 6, 4, 10, 3, 3, 'H1.01.01.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06'),
(236, 82, 16, 12, 48, 3, 3, 'H11.11.02.01', '2022-06-29 18:30:06', '2022-06-29 18:30:06');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `bao_cao_sao_luus`
--
...
CREATE TABLE `binh_luans` (
  ...
  `dinhKem` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `loai_dinhKem` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `nguoiDung_id` int NOT NULL,
  `baoCao_id` int NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `bo_tieu_chuans`
--

INSERT INTO `bo_tieu_chuans` (`id`, `ten`, `capDanhGia_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 'Bộ AUN', NULL, NULL, NULL, NULL),
(2, 'Bộ GDDT', NULL, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `cap_danh_gias`
--
...
--
-- Đang đổ dữ liệu cho bảng `cap_danh_gias`
--
...
--
-- Cấu trúc bảng cho bảng `chi_tiet_minh_chungs`
--
...
--
-- Đang đổ dữ liệu cho bảng `chi_tiet_minh_chungs`
--
...
--
-- Cấu trúc bảng cho bảng `dot_danh_gias`
--
...
CREATE TABLE `dot_danh_gias` (
  ...
  `ten` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `namHoc` int NOT NULL,
  `giaiDoan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `dot_danh_gias`
--
...
--
-- Cấu trúc bảng cho bảng `giai_doans`
--
...
--
-- Đang đổ dữ liệu cho bảng `giai_doans`
--
...
--
-- Cấu trúc bảng cho bảng `hoat_dongs`
--
...
--
-- Đang đổ dữ liệu cho bảng `hoat_dongs`
--
...
--
-- Cấu trúc bảng cho bảng `loai_minh_chungs`
--
...
--
-- Cấu trúc bảng cho bảng `minh_chungs`
--

CREATE TABLE `minh_chungs` (
  `id` bigint UNSIGNED NOT NULL,
  `ten` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `nguonMinhChung_id` int DEFAULT NULL,
  `loaiMinhChung_id` int DEFAULT NULL,
  `ngayKhaoSat` date DEFAULT NULL,
  `ngayBanHanh` date DEFAULT NULL,
  `noiBanHanh` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `minh_chungs`
--
...
(6, 'CTĐT ngành NTTS (2018)', NULL, NULL, '2021-01-01', '2018-01-01', 'Đại học Nha Trang', '/storage/minhchungs/5/08-Jun-2022-02-02-K60_28_CTDT Nuoi trong TS - K60.doc', 12, 0, 5, '2022-06-08 07:02:46', '2022-06-08 07:05:50', NULL),
(7, 'Quy định khối lượng kiến thức tối thiểu', NULL, NULL, '2021-01-01', '2015-01-07', 'Bộ GD&ĐT', '/storage/minhchungs/5/08-Jun-2022-02-05-07_2015_TT-BGDDT_8022.doc', 3, 0, 5, '2022-06-08 07:05:39', '2022-06-08 07:05:39', NULL),
(8, 'Mục tiêu của trường', NULL, NULL, '2021-01-01', '2020-01-01', 'Đại học Nha Trang', '/storage/minhchungs/5/08-Jun-2022-02-07-chien-luoc-phat-trien-2020-tam-nhin-2030.pdf', 3, 0, 5, '2022-06-08 07:07:37', '2022-06-08 07:07:37', NULL),
(9, 'Chuẩn đầu ra CTĐT ngành NTTS', NULL, NULL, '2021-01-01', '2011-01-01', 'Đại học Nha Trang', '/storage/minhchungs/5/08-Jun-2022-02-30-chien-luoc-phat-trien-2020-tam-nhin-2030.pdf', 3, 0, 5, '2022-06-08 07:30:25', '2022-06-08 07:30:25', NULL),
(10, 'Thành lập Ban Chủ nhiệm CTĐT ngành NTTS', NULL, NULL, '2021-01-01', '2019-01-01', 'Đại học Nha Trang', '/storage/minhchungs/5/08-Jun-2022-02-36-K60_28_CTDT Nuoi trong TS - K60.doc', 3, 0, 5, '2022-06-08 07:36:10', '2022-06-08 07:36:10', NULL),
(11, 'Phiếu khảo sát các bên liên quan phục vụ cập nhật CĐR', NULL, NULL, '2021-01-01', '2020-01-01', 'BCN CTĐT ngành NTTS', '/storage/minhchungs/5/08-Jun-2022-02-37-07_2015_TT-BGDDT_8022.doc', 12, 0, 5, '2022-06-08 07:37:08', '2022-06-08 07:37:08', NULL),
(12, 'Biên bản hội nghị lấy ý kiến các bên liên quan phục vụ cập nhật CTĐT (có CĐR)', NULL, NULL, '2021-01-01', '2020-01-01', 'BCN CTĐT ngành NTTS', '/storage/minhchungs/5/08-Jun-2022-02-37-chien-luoc-phat-trien-2020-tam-nhin-2030.pdf', 12, 0, 5, '2022-06-08 07:37:36', '2022-06-08 07:37:36', NULL),
(13, 'Quy định/quy trình xây dựng CTĐT và Quy định về tiêu chuẩn đánh giá chất lượng CTĐT', NULL, NULL, '2021-01-01', '2016-01-01', 'Bộ GD&ĐT', '/storage/minhchungs/5/08-Jun-2022-02-43-07_2015_TT-BGDDT_8022.doc', 3, 0, 5, '2022-06-08 07:43:35', '2022-06-08 07:43:35', NULL),
(14, 'Giao quản lý ngành đào tạo', NULL, NULL, '2021-01-02', '2018-01-01', 'Đại học Nha Trang', '/storage/minhchungs/5/08-Jun-2022-02-44-chien-luoc-phat-trien-2020-tam-nhin-2030.pdf', 3, 0, 5, '2022-06-08 07:44:29', '2022-06-08 07:44:40', NULL),
(15, 'Công bố CTĐT ngành NTTS trên website đơn vị', NULL, NULL, '2021-01-01', '2020-01-01', 'Đại học Nha Trang', '/storage/minhchungs/5/08-Jun-2022-02-50-K60_28_CTDT Nuoi trong TS - K60.doc', 12, 0, 5, '2022-06-08 07:50:59', '2022-06-08 07:50:59', NULL),
(16, 'Minh chứng gộp', NULL, NULL, '2020-01-01', '2019-01-01', 'Đại học Nha Trang', NULL, 6, 1, 5, '2022-06-11 19:17:47', '2022-06-11 19:17:47', NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `moc_chuans`
--
...
--
-- Đang đổ dữ liệu cho bảng `moc_chuans`
--
...
--
-- Cấu trúc bảng cho bảng `nganh_dot_danh_gias`
--
...
--
-- Đang đổ dữ liệu cho bảng `nganh_dot_danh_gias`
--
...
--
-- Cấu trúc bảng cho bảng `nguoi_dung_quyens`
--

CREATE TABLE `nguoi_dung_quyens` (
  `id` bigint UNSIGNED NOT NULL,
  `nhomNguoiDung_id` int NOT NULL,
  `quyenNguoiDung_id` int NOT NULL,
  `baoCao_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Đang đổ dữ liệu cho bảng `nguoi_dung_quyens`
--
...
--
-- Cấu trúc bảng cho bảng `nguoi_dung_vai_tro_h_t_s`
--

CREATE TABLE `nguoi_dung_vai_tro_h_t_s` (
  `id` bigint UNSIGNED NOT NULL,
  `nguoiDung_id` int NOT NULL,
  `vaiTroHT_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Đang đổ dữ liệu cho bảng `nguoi_dung_vai_tro_h_t_s`
--
...
--
-- Cấu trúc bảng cho bảng `nguon_minh_chungs`
--
...
--
-- Đang đổ dữ liệu cho bảng `nhoms`
--
...
--
-- Cấu trúc bảng cho bảng `nhom_nguoi_dungs`
--
...
CREATE TABLE `nhom_nguoi_dungs` (
  ...
  `nguoiDung_id` int NOT NULL,
  `vaiTro_id` int NOT NULL DEFAULT '1',
  `nganh_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Đang đổ dữ liệu cho bảng `nhom_nguoi_dungs`
--
...
--
-- Cấu trúc bảng cho bảng `nhom_quyens`
--

CREATE TABLE `nhom_quyens` (
  `id` bigint UNSIGNED NOT NULL,
  `nhom_id` int NOT NULL,
  `quyenNhom_id` int NOT NULL,
  `tieuChuan_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Đang đổ dữ liệu cho bảng `nhom_quyens`
--
...
--
-- Cấu trúc bảng cho bảng `quyen_h_t_s`
--
...
--
-- Đang đổ dữ liệu cho bảng `quyen_h_t_s`
--
...
--
-- Cấu trúc bảng cho bảng `quyen_nguoi_dungs`
--
...
--
-- Đang đổ dữ liệu cho bảng `quyen_nguoi_dungs`
--
...
--
-- Cấu trúc bảng cho bảng `quyen_nhoms`
--
...
--
-- Đang đổ dữ liệu cho bảng `quyen_nhoms`
--
...
--
-- Cấu trúc bảng cho bảng `tieu_chis`
--
...
--
-- Đang đổ dữ liệu cho bảng `tieu_chis`
--
...
--
-- Cấu trúc bảng cho bảng `tieu_chi_tu_khoas`
--

CREATE TABLE `tieu_chi_tu_khoas` (
  `id` bigint UNSIGNED NOT NULL,
  `tieuChi_id` int NOT NULL,
  `tuKhoa_id` int NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Cấu trúc bảng cho bảng `tieu_chuans`
--
...
CREATE TABLE `tieu_chuans` (
  ...
  `stt` int NOT NULL,
  `ten` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `boTieuChuan_id` int DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
--
-- Đang đổ dữ liệu cho bảng `tieu_chuans`
--

INSERT INTO `tieu_chuans` (`id`, `stt`, `ten`, `boTieuChuan_id`, `created_at`, `updated_at`, `deleted_at`) VALUES
(2, 1, 'Mục tiêu và chuẩn đầu ra của chương trình đào tạo', NULL, '2022-05-25 18:44:48', '2022-05-25 18:44:48', NULL),
(3, 2, 'Bản mô tả chương trình đào tạo', NULL, '2022-05-25 18:45:12', '2022-06-29 11:47:35', NULL),
(4, 3, 'Cấu trúc và nội dung chương trình dạy học', NULL, '2022-05-25 18:45:32', '2022-06-29 11:47:35', NULL),
(5, 4, 'Phương pháp tiếp cận trong dạy và học', NULL, '2022-05-25 18:45:47', '2022-05-25 18:45:47', NULL),
(6, 5, 'Đánh giá kết quả học tập của người học', NULL, '2022-05-25 18:46:04', '2022-05-25 18:46:04', NULL),
(7, 6, 'Đội ngũ giảng viên, nghiên cứu viên', NULL, '2022-05-25 18:46:19', '2022-05-25 18:46:19', NULL),
(8, 7, 'Đội ngũ nhân viên', NULL, '2022-05-25 18:46:34', '2022-05-25 18:46:34', NULL),
(9, 8, 'Người học và hoạt động hỗ trợ người học', NULL, '2022-05-25 18:46:47', '2022-05-25 18:46:47', NULL),
(10, 9, 'Cơ sở vật chất và trang thiết bị', NULL, '2022-05-25 18:46:59', '2022-05-25 18:46:59', NULL),
(11, 10, 'Nâng cao chất lượng', NULL, '2022-05-25 18:47:15', '2022-05-25 18:47:15', NULL),
(12, 11, 'Kết quả đầu ra', NULL, '2022-05-25 18:47:27', '2022-05-25 18:47:27', NULL);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `tu_khoas`
--
...
(4, 'Phan Thanh Hà', 1, '2000-03-08', '0334370822', 'Sinh Viên', 'hathanh.0113@gmail.com', NULL, '$2y$10$/4Wne/t8CJkSpQL2Ic1OQurUS0hvTLGIi3om/GrqaseJeO5NT.lvy', 1, '7eDg1DBlta7NkaPZcJ7YCnmb8eDeGwQ7a0BQpL6GG1Eh4IQalSHiF0Wy9CHA', '2022-05-25 23:31:11', '2022-05-25 23:31:55', '/storage/photos/4/26-May-2022-01-31-avatar2.jpg', NULL),
(5, 'Phạm Thị Thu Thúy', 0, '1978-06-24', '0901905679', 'Trưởng khoa CNTT', 'thuthuy@ntu.edu.vn', NULL, '$2y$10$9cTZjyUfONAdeL5iTGehK.ad9Tcmxm6Oe60WgnIf2gg5IEq5RGoYq', 1, 'QpnFoXYpX12wC6IaK2wmzrlBc42tSzJ6OdOLPgf7CgGrZpmGxGimswwoz3TJ', '2022-05-31 23:54:26', '2022-05-31 23:54:26', '/img/girl-1.png', NULL),
...
(12, 'Phạm Thị Kim Ngoan', 0, '1977-01-01', '0985102114', 'Trưởng BM KTPM', 'ngoanptk@ntu.edu.vn', NULL, '$2y$10$NchBqY5kHOnoIJaP16ptl.XfUl5n/bm8IPUujWbjJxUTw5z6RGX/S', 1, NULL, '2022-06-01 00:17:18', '2022-06-01 00:17:18', '/img/girl-1.png', NULL),
...
--
-- Cấu trúc bảng cho bảng `vai_tro_h_t_quyen_h_t_s`
--

CREATE TABLE `vai_tro_h_t_quyen_h_t_s` (
  `id` bigint UNSIGNED NOT NULL,
  `vaiTroHT_id` int NOT NULL,
  `quyenHT_id` int NOT NULL,
...
--
-- Đang đổ dữ liệu cho bảng `vai_tro_h_t_quyen_h_t_s`
--
...
--
-- Cấu trúc bảng cho bảng `vai_tro_h_t_s`
--
...
--
-- Đang đổ dữ liệu cho bảng `vai_tro_h_t_s`
--
...
--
-- Cấu trúc bảng cho bảng `yeu_caus`
--
...
--
-- Chỉ mục cho bảng `bao_caos`
--
ALTER TABLE `bao_caos`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `bao_cao_minh_chungs`
--
ALTER TABLE `bao_cao_minh_chungs`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `bao_cao_sao_luus`
--
...
--
-- Chỉ mục cho bảng `bo_tieu_chuans`
--
ALTER TABLE `bo_tieu_chuans`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `cap_danh_gias`
--
ALTER TABLE `cap_danh_gias`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `chi_tiet_minh_chungs`
--
...
--
-- Chỉ mục cho bảng `dot_danh_gias`
--
...
--
-- Chỉ mục cho bảng `giai_doans`
--
ALTER TABLE `giai_doans`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `hoat_dongs`
--
ALTER TABLE `hoat_dongs`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `loai_minh_chungs`
--
...
--
-- Chỉ mục cho bảng `minh_chungs`
--
ALTER TABLE `minh_chungs`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `moc_chuans`
--
...
--
-- Chỉ mục cho bảng `nganh_dot_danh_gias`
--
ALTER TABLE `nganh_dot_danh_gias`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `nguoi_dung_quyens`
--
ALTER TABLE `nguoi_dung_quyens`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `nguoi_dung_vai_tro_h_t_s`
--
ALTER TABLE `nguoi_dung_vai_tro_h_t_s`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `nguon_minh_chungs`
--
ALTER TABLE `nguon_minh_chungs`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `nhoms`
--
ALTER TABLE `nhoms`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `nhom_nguoi_dungs`
--
ALTER TABLE `nhom_nguoi_dungs`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `nhom_quyens`
--
...
--
-- Chỉ mục cho bảng `quyen_h_t_s`
--
ALTER TABLE `quyen_h_t_s`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `quyen_nguoi_dungs`
--
ALTER TABLE `quyen_nguoi_dungs`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `quyen_nhoms`
--
ALTER TABLE `quyen_nhoms`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `tieu_chis`
--
ALTER TABLE `tieu_chis`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `tieu_chi_tu_khoas`
--
ALTER TABLE `tieu_chi_tu_khoas`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `tieu_chuans`
--
ALTER TABLE `tieu_chuans`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `tu_khoas`
--
...
--
-- Chỉ mục cho bảng `vai_tro_h_t_quyen_h_t_s`
--
ALTER TABLE `vai_tro_h_t_quyen_h_t_s`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `vai_tro_h_t_s`
--
ALTER TABLE `vai_tro_h_t_s`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `yeu_caus`
--
...
--
-- AUTO_INCREMENT cho bảng `bao_caos`
--
ALTER TABLE `bao_caos`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=87;

--
-- AUTO_INCREMENT cho bảng `bao_cao_minh_chungs`
--
ALTER TABLE `bao_cao_minh_chungs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=237;

--
-- AUTO_INCREMENT cho bảng `bao_cao_sao_luus`
--
ALTER TABLE `bao_cao_sao_luus`
...
--
-- AUTO_INCREMENT cho bảng `bo_tieu_chuans`
--
ALTER TABLE `bo_tieu_chuans`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `cap_danh_gias`
--
ALTER TABLE `cap_danh_gias`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT cho bảng `chi_tiet_minh_chungs`
--
ALTER TABLE `chi_tiet_minh_chungs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT cho bảng `dot_danh_gias`
--
ALTER TABLE `dot_danh_gias`
...
--
-- AUTO_INCREMENT cho bảng `giai_doans`
--
ALTER TABLE `giai_doans`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT cho bảng `hoat_dongs`
--
ALTER TABLE `hoat_dongs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `loai_minh_chungs`
--
ALTER TABLE `loai_minh_chungs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `minh_chungs`
--
ALTER TABLE `minh_chungs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT cho bảng `moc_chuans`
--
ALTER TABLE `moc_chuans`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT cho bảng `nganhs`
--
ALTER TABLE `nganhs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `nganh_dot_danh_gias`
--
ALTER TABLE `nganh_dot_danh_gias`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `nguoi_dung_quyens`
--
ALTER TABLE `nguoi_dung_quyens`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;

--
-- AUTO_INCREMENT cho bảng `nguoi_dung_vai_tro_h_t_s`
--
ALTER TABLE `nguoi_dung_vai_tro_h_t_s`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT cho bảng `nguon_minh_chungs`
--
ALTER TABLE `nguon_minh_chungs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `nhoms`
--
ALTER TABLE `nhoms`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT cho bảng `nhom_nguoi_dungs`
--
ALTER TABLE `nhom_nguoi_dungs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT cho bảng `nhom_quyens`
--
ALTER TABLE `nhom_quyens`
...
--
-- AUTO_INCREMENT cho bảng `quyen_h_t_s`
--
ALTER TABLE `quyen_h_t_s`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=64;

--
-- AUTO_INCREMENT cho bảng `quyen_nguoi_dungs`
--
ALTER TABLE `quyen_nguoi_dungs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `quyen_nhoms`
--
ALTER TABLE `quyen_nhoms`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `tieu_chis`
--
ALTER TABLE `tieu_chis`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=63;

--
-- AUTO_INCREMENT cho bảng `tieu_chi_tu_khoas`
--
ALTER TABLE `tieu_chi_tu_khoas`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `tieu_chuans`
--
ALTER TABLE `tieu_chuans`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT cho bảng `tu_khoas`
--
ALTER TABLE `tu_khoas`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `vai_tro_h_t_quyen_h_t_s`
--
ALTER TABLE `vai_tro_h_t_quyen_h_t_s`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=124;

--
-- AUTO_INCREMENT cho bảng `vai_tro_h_t_s`
--
ALTER TABLE `vai_tro_h_t_s`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `yeu_caus`
--
ALTER TABLE `yeu_caus`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT;
COMMIT;
